...
$$
C=D^{-1}-\eta D^{-1}uu^TD^{-1}\\
\eta = \frac{1}{u^TD^{-1} u+1}\\
...
$$
C_{l_{i,j}} = \frac{1}{\frac{1}{C_{ p,l_{i,j} } }+\frac{1}{C_{ q,l_{i,j} } } }\\

\mu_{l_{i}}=\frac{\frac{\mu_{q_{i}}}{C_{q,l_{i,i}}}+\frac{\mu_{p_{i}}}{C_{ {p,l}_{i,i} } } }{\frac{1}{C_{ p,l_{i,j} } }+\frac{1}{C_{ q,l_{i,j} } } }
$$
